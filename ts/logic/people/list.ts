    ...
    return [
        {
            name: "Dave",
            tasks: [
                new SleepTask({ start: 0, end: 7, location: mapManager.getLocation("deck3") }),
                new EatTask({ start: 7, end: 9, location: mapManager.getLocation("deck0") }),
                new WorkTask({ start: 9, end: 12, location: mapManager.getLocation("deck1") }),
                new EngineTask({ start: 13, end: 17, location: mapManager.getLocation("wheel") }),
